      ...
      <main>
        ...
        >
          <div className={css.contentHolder}>
            ...
            <p>Made of the most recent and the best tech in React world.<br /><strong>Babel 6</strong>, <strong>Webpack 3</strong>, <strong>React 16</strong>, <strong>React-Router 5</strong>, <strong>CSS-Modules</strong> are the main gears of the project. <strong>Development</strong> and <strong>Production</strong> environments for easy daily routines.</p>
          </div>
        </Section>
